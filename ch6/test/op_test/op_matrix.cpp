...
TEST(test_op, matrix_row_col_sum) {
    ...
    mop::get_mat_row_sum_op<float>(mbase::DeviceType::Device)(d_A, d_sums, DSIZE);
    ...
    mop::get_mat_col_sum_op<float>(mbase::DeviceType::Device)(d_A, d_sums, DSIZE);
